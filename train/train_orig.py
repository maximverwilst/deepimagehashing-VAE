...
def train(set_name, bbn_dim, cbn_dim, batch_size, middle_dim=1024, max_iter=100000):
    ...
    for i in range(max_iter):
        with writer.as_default():
            ...
            if (i + 1) % 100 == 0:
                train_hook = hook(train_code, train_code, train_label, train_label, min(batch_size,1000))
                ...
                writer.flush()
                print('batch {}: train_hook {}, actor {}, critic {}'.format(i, train_hook, actor_loss, critic_loss))#, cur_mi))
